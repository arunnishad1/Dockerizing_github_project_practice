...
const dbURI = "mongodb://host.docker.internal:27017/Demo";  // this line code is essential because it make sure that application running inside make use of my own PC's localhost Mongodb database connection

mongoose.connect(dbURI, { useNewUrlParser: true, useUnifiedTopology: true }) //this return promise
  .then((result) =>{ console.log("Database-connected"); app.listen(8081)})
